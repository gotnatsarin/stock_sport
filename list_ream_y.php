         ...
         <h3 class="box-title">จัดการเบิกอุปกรณ์กีฬา</h3>
          <div class="box box-success">
            <div class="box-header label-success">
              <h3 class="box-title">(ได้รับการอนุมัติ)</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="ream_stock" class="table table-bordered table-striped">
                ...
                <?
					...
					$strSQLr = "SELECT * FROM ream 
								inner join material on (material.id_mat = ream.id_mat) where ream.status = 'Y' ";
                ...
                <tr>
                  ...
                  <td style="text-align:center;"><div class="label-success">อนุมัติเบิก</div></td>
                </tr>
                <? $numr++;	} ?>
                </tbody>
