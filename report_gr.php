        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header label-primary">
              <h3 class="box-title">รายงานสถิติการยืมอุปกรณ์กีฬา</h3>
            </div>
            <!-- /.box-header -->
            <form action="">
            <div class="box-body">
              ...
              <table class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th style="text-align:center;" width="10%">จำนวนอุปกรณ์</th>
                  <th style="text-align:center;" width="10%">จำนวนครั้ง</th>
                </tr>
                </thead>
                <tbody>
                <?
					if($_GET["start_date"] != ""){
						if($_GET["end_date"] == ""){
							echo "<script>
								...
								window.location.href = 'report_gr.php?menu=report';
							</script>";
					...
					$num=1;
					$no=1;
					$strSQLr = "SELECT *, SUM(ream.num_ream) as numream FROM ream 
								inner join material on (material.id_mat = ream.id_mat) where material.id_mat != '' $search group by ream.id_mat ORDER BY  ream.date_ream DESC ";
					
					$stmtr  = mysql_query($strSQLr);
					$num_gp = mysql_num_rows($stmtr);
					while($rowr = mysql_fetch_array($stmtr)){
						...
						$strSQL_count = "SELECT COUNT(id_mat) as count_mat FROM ream where id_mat = '".$rowr[id_mat]."' ";
						$stmt_count = mysql_query($strSQL_count);
						$row_count = mysql_fetch_array($stmt_count);
						...
						if($num_gp == $no){
							$txt_gp .= "{ name: '".$rowr['name_material']." ยืมไป ".$rowr['numream'].$rowur['name_unit']."  ', y: ".$row_count['count_mat']." }";
						}else{
							$txt_gp .= "{ name: '".$rowr['name_material']." ยืมไป ".$rowr['numream'].$rowur['name_unit']."  ', y: ".$row_count['count_mat']." },";
						}
						$no++;
                ...
                <tr>
                  ...
                  <td><?=$rowr[numream];?> <?=$rowur[name_unit];?></td>
                  <td style="text-align:center;"><?=$row_count[count_mat];?></td>
                </tr>
                <? $num++; } ?>
                </tbody>
              ...
              <script src="gp/jquery.min.js"></script>
				<script src="gp/highcharts.js"></script>
                ...
                <div align="center">
						...
						chart = new Highcharts.chart('container', {
							...
							title: {
								text: 'รายงานสถิติการยืมอุปกรณ์กีฬา'
							},
							tooltip: {
