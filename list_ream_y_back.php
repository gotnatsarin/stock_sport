         ...
         <h3 class="box-title">จัดการคืนอุปกรณ์กีฬา</h3>
          <div class="box box-success">
            <div class="box-header label-success">
              <h3 class="box-title">(ได้รับการอนุมัติคืน)</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="ream_stock" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th style="text-align:center;" width="10%">อนุมัติ</th>
                </tr>
                </thead>
                <tbody>
                <?
                ...
                <tr>
                  ...
                  <td style="text-align:center;"><?=date('d/m/Y', strtotime($rowr[date_back]));?></td>
                  <td>
                  ...
                  <td style="text-align:center;"><div class="label-success">รับคืน</div></td>
                </tr>
                <? $numr++;	} ?>
                </tbody>
