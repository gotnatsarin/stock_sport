        ...
        <div class="col-xs-12">
          <div class="box box-info">
            <div class="box-header label-info">
              <h3 class="box-title">ประวัติการเบิก</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="ream_stock" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th style="text-align:center;" width="8%">วันที่เบิก</th>
                  <th style="text-align:center;" width="10%">วันที่กำหนดคืน</th>
                  <th style="text-align:center;" width="8%">วันที่คืน</th>
                  <th style="text-align:center;" width="10%">ค่าปรับ</th>
                  <th style="text-align:center;" width="8%">การอนุมัติ</th>
                ...
                <tr>
                  ...
                  <td style="text-align:center;">
                  	<?
						if($rowr[status] == ''){
					?>
                  		<a href="edit_ream.php?id_ream=<?=$rowr["id_ream"];?>" class="btn btn-warning btn-sm">แก้ไข</a>
       			 		<a href="JavaScript:if(confirm('ยืนยันยกเลิการเบิก ?')==true){window.location='<?=$_SERVER["PHP_SELF"];?>?Action=Del&id_ream=<?=$rowr["id_ream"];?>';}" class="btn btn-danger btn-sm">ลบ</a>
                    <? }else{
							if($rowr[status] == 'Y'){
								echo '<div class="label label-success">อนุมัติ</div>';
							}else if($rowr[status] == 'N'){
