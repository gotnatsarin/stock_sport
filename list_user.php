              ...
              <table id="stock_v" class="table table-bordered table-striped">
                ...
                <?
					if($_GET["Action"] == "Del")
					{
						...
						$strSQL .="WHERE id_user = '".$_GET["id_user"]."' ";
                ...
                <tr>
                  ...
                  <td style="text-align:center;">
                  		<a href="edit_user.php?id_user=<?=$row["id_user"];?>" class="btn btn-warning">แก้ไข</a>
       			 		<!-- / 
                        <a href="JavaScript:if(confirm('ยืนยันลบชื่อหน่วย ?')==true){window.location='<?=$_SERVER["PHP_SELF"];?>?Action=Del&id=<?=$row["id"];?>';}" class="btn btn-danger">ลบ</a> 
                        -->
                  </td>
                </tr>
                <? $num++; } ?>
