        ...
        <div class="col-xs-12">
          <div class="box box-warning">
            <div class="box-header label-warning">
              <h3 class="box-title">คืนอุปกรณ์กีฬา(รอการคืน)</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="ream_stock" class="table table-bordered table-striped">
                ...
                <?
					...
					$strSQLr = "SELECT * FROM ream 
						...
						where ream.id_user = '".$_SESSION["id_user"]."' and ream.status = 'Y' ";
                  ...
                  <td style="text-align:center;">
				  	<?
						if($rowr[date_back] == '0000-00-00'){
							...
							echo date('d/m/Y', strtotime($rowr[date_ream]));
						}
					?>
                  </td>
                  <td style="text-align:center;">
                  		<a href="JavaScript:if(confirm('ยืนยันการคืนอุปกรณ์กีฬา ?')==true){window.location='<?=$_SERVER["PHP_SELF"];?>?Action=Yes&id_ream=<?=$rowr["id_ream"];?>';}" class="btn btn-success">ทำคืนอุปกรณ์กีฬา</a>
                  </td>
                </tr>
                <? $numr++;	} ?>
                </tbody>
