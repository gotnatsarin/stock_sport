  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-xs-12">
         <h3 class="box-title">จัดการคืนอุปกรณ์</h3>
          <div class="box box-danger">
            <div class="box-header label-danger">
              <h3 class="box-title">(ไม่ได้รับการอนุมัติคืน)</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="ream_stock" class="table table-bordered table-striped">
                ...
                <?
					...
					$strSQLr = "SELECT * FROM ream 
								inner join material on (material.id_mat = ream.id_mat) where material.type_mat = '2' and ream.status = 'BN' ";
                ...
                <tr>
                  ...
                  <td style="text-align:center;"><div class="label-danger">ไม่รับคืน</div></td>
                </tr>
                <? $numr++;	} ?>
                </tbody>
