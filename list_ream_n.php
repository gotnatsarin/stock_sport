        ...
        <div class="col-xs-12">
         <h3 class="box-title">จัดการเบิกอุปกรณ์กีฬา</h3>
          <div class="box box-danger">
            <div class="box-header label-danger">
              <h3 class="box-title">(ไม่อนุมัติ)</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="ream_stock" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th style="text-align:center;" width="10%">ไม่อนุมัติ</th>
                </tr>
                </thead>
                <tbody>
                <?
					...
					$strSQLr = "SELECT * FROM ream 
								inner join material on (material.id_mat = ream.id_mat) where ream.status = 'N' ";
                ...
                <tr>
                  ...
                  <td style="text-align:center;"><div class="label-danger">ไม่อนุมัติเบิก</div></td>
                </tr>
                <? $numr++;	} ?>
                </tbody>
